...
namespace FinalProject_QUANLYKHO.Contanst
{
    internal class ContanstApp
    {
        ...
        public static String CONNECT_DB_URL = @"Data Source=LAPTOP-HQS92G2N\ILOVEIU3K;Initial Catalog=QUANLYKHOHANG;MultipleActiveResultSets=true;Integrated Security=True";
    }
}
