...
namespace FinalProject_QUANLYKHO.View.CustomerView
{
    public partial class ModalAddCustomer : Form
    {
        ...
        private void inputName__TextChanged(object sender, EventArgs e)
        {

        }

        private void inputPhoneNumber__TextChanged(object sender, EventArgs e)
        {
        }
        ...
        private void inputAddress__TextChanged(object sender, EventArgs e)
        {
        }
